...
## [1.4.3](https://github.com/mavinnarath/dmarcguard/compare/v1.5.4...v1.4.3) (2026-06-29)


### Features

* add CI and goreleaser with optimized distroless docker ([66c6828](https://github.com/mavinnarath/dmarcguard/commit/66c682807d5ed12328349e2713c9d814d6337e78))
* add DigitalOcean Droplet and Dokploy deployment options ([#67](https://github.com/mavinnarath/dmarcguard/issues/67)) ([21d494f](https://github.com/mavinnarath/dmarcguard/commit/21d494f60d7b7450d29cfd9a50fa25a914b100e8))
* add MCP server integration to project ([#46](https://github.com/mavinnarath/dmarcguard/issues/46)) ([807b8d6](https://github.com/mavinnarath/dmarcguard/commit/807b8d677c81aef6ac39605bffb7125680841d4a))
* add production-ready Grafana dashboard ([6f857fe](https://github.com/mavinnarath/dmarcguard/commit/6f857fe660144093b8766f529c15b17a21edc3b2))
* add production-ready Prometheus metrics ([#39](https://github.com/mavinnarath/dmarcguard/issues/39)) ([17f6968](https://github.com/mavinnarath/dmarcguard/commit/17f69681b23eee92ff1bc908fde7da2de11b8a52))
* add sort and refresh to UI ([9d6853e](https://github.com/mavinnarath/dmarcguard/commit/9d6853e95319529c40958ae60d95d05d8cb5a675))
* allow changing api endpoint from the settings modal ([#76](https://github.com/mavinnarath/dmarcguard/issues/76)) ([e6cb48b](https://github.com/mavinnarath/dmarcguard/commit/e6cb48be538e5c3e997d86dda9250068a2fb377e))
* allow customizing SEEN & move-folder behavior after processing ([80346df](https://github.com/mavinnarath/dmarcguard/commit/80346dfddc56844dd59c9474fb788ca1d0d9312c)), closes [#118](https://github.com/mavinnarath/dmarcguard/issues/118)
* **CI:** add man page and shell completion to brew ([0e45ed2](https://github.com/mavinnarath/dmarcguard/commit/0e45ed2a10d26a06fadc6a2fdfe3b81ad5a01197))
* **CI:** add mcp registry publishing to goreleaser ([a0d6f88](https://github.com/mavinnarath/dmarcguard/commit/a0d6f88eb54df004c3b35ef7e256bb8d7be36cc9))
* **CI:** add prettier job ([39af52d](https://github.com/mavinnarath/dmarcguard/commit/39af52d186fcf75dba2f8ac05ef313808f1e01b4))
* **CI:** build docker via goreleaser ([8555265](https://github.com/mavinnarath/dmarcguard/commit/855526505aa48c9ab1cdc946f10370a875ee47d8))
* **CI:** install pandoc and use official goreleaser action ([0d0a307](https://github.com/mavinnarath/dmarcguard/commit/0d0a3077395a9879a9d036166b4afbab43ee164e))
* clean up the cli and optimize the docker ([db23ba4](https://github.com/mavinnarath/dmarcguard/commit/db23ba4ff2fd80ad1c016daa73a57519998dd271))
* **docs:** add 1-click deployment at the top of README ([#41](https://github.com/mavinnarath/dmarcguard/issues/41)) ([50d2ff2](https://github.com/mavinnarath/dmarcguard/commit/50d2ff2c54a506801e802daa6b5d375b79d1281d))
* **docs:** add nerdy badges to README ([#23](https://github.com/mavinnarath/dmarcguard/issues/23)) ([5026a45](https://github.com/mavinnarath/dmarcguard/commit/5026a45da22a9fa0a3c831945da4afaa05c2dd7c))
* **docs:** add northflank deployment button ([81215a5](https://github.com/mavinnarath/dmarcguard/commit/81215a5b5e8cd87aa5f601f22fb460b4929d8d15))
* **docs:** add the self-hosted options to deployments ([42ab966](https://github.com/mavinnarath/dmarcguard/commit/42ab966218b9e875ed438a9cb4a4b4ac3adb9b33))
* **docs:** add zeabur deployment template ([4abaa36](https://github.com/mavinnarath/dmarcguard/commit/4abaa36d9b077f71a3e6da841af056dffbe046ba))
* **docs:** update readme to the latest changes ([c20e0cf](https://github.com/mavinnarath/dmarcguard/commit/c20e0cf837b91b05e61153e4e55e7315fb09d396))
* ensure db path exists and add demo screenshot ([42d6d14](https://github.com/mavinnarath/dmarcguard/commit/42d6d14fd96f2818830c73ad4e23b8f97719c497))
* **frontend:** add DMARC DNS record generator ([34491ba](https://github.com/mavinnarath/dmarcguard/commit/34491ba244f9af48a25e3a0d6b09979661678c0d))
* **frontend:** implement dark mode with theme toggle ([#35](https://github.com/mavinnarath/dmarcguard/issues/35)) ([569fd36](https://github.com/mavinnarath/dmarcguard/commit/569fd3649931f94fa4f39845d0f141afacd6fbc0))
* Implement DMARC report parser with Vue.js dashboard ([#1](https://github.com/mavinnarath/dmarcguard/issues/1)) ([23b8ac0](https://github.com/mavinnarath/dmarcguard/commit/23b8ac0cc63a81aad7dfa2385ed24f6d74915775))
* **mcp:** add OAuth2 authentication for MCP HTTP server ([361f078](https://github.com/mavinnarath/dmarcguard/commit/361f0782e2f20b7160873a085e600adc68988432))
* **UI:** revamp the dashboard for actionable insights ([#68](https://github.com/mavinnarath/dmarcguard/issues/68)) ([dbe073d](https://github.com/mavinnarath/dmarcguard/commit/dbe073d35a7f349770e9fab6df4923e221c350f2))
* update the UI footer with OS friendly text ([5008fdf](https://github.com/mavinnarath/dmarcguard/commit/5008fdf5e59e5b4af1fc12ccafc644d27ccdbdfc))
* update UI footer & readme and optimize vite ([9578d05](https://github.com/mavinnarath/dmarcguard/commit/9578d0530adab10334ad1a8a20c563abdc589854))


### Bug Fixes

* accept fetch-interval without prefix ([06fd520](https://github.com/mavinnarath/dmarcguard/commit/06fd520d1a816795d8e35f6a7c9b1b5eed5c096c)), closes [#162](https://github.com/mavinnarath/dmarcguard/issues/162)
* address unhandled charset ([#87](https://github.com/mavinnarath/dmarcguard/issues/87)) ([99c245a](https://github.com/mavinnarath/dmarcguard/commit/99c245a670ce1cb44f5d08b24b5d0c99c502ec69))
* **CI:** add current dir to docker build context ([254cc6a](https://github.com/mavinnarath/dmarcguard/commit/254cc6a6b0b88afc67af8a1cdc4a41d1b71ff1a6))
* **CI:** add the brew token ([4081621](https://github.com/mavinnarath/dmarcguard/commit/4081621ae9d1771185712512a912aa350a2e0305))
* **CI:** build on major version as well ([fdff51d](https://github.com/mavinnarath/dmarcguard/commit/fdff51d2c77d55e890e5b6d9c12ce316ddec2542))
* **CI:** change mcp auth type to gh oidc ([1132b50](https://github.com/mavinnarath/dmarcguard/commit/1132b5038c16fda2c83fe90a83f9f6e802c06af4))
* **CI:** disable attestation digest for docker build ([95d6665](https://github.com/mavinnarath/dmarcguard/commit/95d666543f59b3a890ea8921275f840eebb32f8e))
* **CI:** disable publishing to mcp registry ([c2e3969](https://github.com/mavinnarath/dmarcguard/commit/c2e3969e90554479921437be4df0d011b4214a89))
* **CI:** disable sbom on docker ([36e5cc4](https://github.com/mavinnarath/dmarcguard/commit/36e5cc4d829efa633fc75879e0a132d076866318))
* **CI:** disable sbom via config ([6b0f3be](https://github.com/mavinnarath/dmarcguard/commit/6b0f3be7d79cafe1eeb0930d2f30bf02f53c56af))
* **CI:** ensure a fake dist exists before golangci-lint ([4e01983](https://github.com/mavinnarath/dmarcguard/commit/4e01983f13a16ab0a8ea7cb880e43b39c285ba1f))
* **CI:** make linter happy ([cd04dfc](https://github.com/mavinnarath/dmarcguard/commit/cd04dfc8beae30b0405d38834680011cd7d14fe5))
* **CI:** move bundled dist to server directory ([59dabf1](https://github.com/mavinnarath/dmarcguard/commit/59dabf1becfc22fddda4bfdab6dd22188396b4c3))
* **CI:** name docker repo explicitly ([0ebbf87](https://github.com/mavinnarath/dmarcguard/commit/0ebbf87a6aad51ad735434982734105d79a97893))
* **CI:** only pin main with latest ([f120b2e](https://github.com/mavinnarath/dmarcguard/commit/f120b2e7b7985adbaa815b6104f8aaee44e8e9ce))
* **CI:** perform keyless docker sign ([1f322d3](https://github.com/mavinnarath/dmarcguard/commit/1f322d33999d3586880d82c5ce3570b60157cd21))
* **CI:** publish to casks for a change ([0e8346b](https://github.com/mavinnarath/dmarcguard/commit/0e8346b3e1c3dcc557445370f59ea7c93588c1fd))
* **CI:** publish to ghcr.io as well ([9c0bf28](https://github.com/mavinnarath/dmarcguard/commit/9c0bf284a08c50487bb6e8fe475b0248a836cedc))
* **CI:** publish to new and old docker hub repo ([e7eda52](https://github.com/mavinnarath/dmarcguard/commit/e7eda52d98e7d3d7d127f199f0f06376007e5cb4))
* **CI:** remove annotations from docker build ([b5d0cd6](https://github.com/mavinnarath/dmarcguard/commit/b5d0cd650ba0dd780ea95ec35c82940620aad6bb))
* **CI:** remove changelog from release note ([127cb80](https://github.com/mavinnarath/dmarcguard/commit/127cb800f3f285b2d5899561fa390e2894bd52de))
* **CI:** remove docker repo from old ghcr.io ([d3f24c0](https://github.com/mavinnarath/dmarcguard/commit/d3f24c00961876ac7bd8a976a16ada168a59be28))
* **CI:** remove incomplete mcp docker from goreleaser ([356bb7b](https://github.com/mavinnarath/dmarcguard/commit/356bb7b8ead6c3b783811178e49e10145a876d29))
* **CI:** remove mcp entry from goreleaser altogether ([1d769a4](https://github.com/mavinnarath/dmarcguard/commit/1d769a45d05ea5afc5340e87fb60cec3fe3514ce))
* **CI:** reverse the conditional for build-dev job ([ce8b417](https://github.com/mavinnarath/dmarcguard/commit/ce8b417c65c62563886787df3871200679c8de66))
* **CI:** reverse the digest conditional for provenance ([9c0e165](https://github.com/mavinnarath/dmarcguard/commit/9c0e165ec1cfeb58c7c535ec02bd0c81e60ba501))
* **CI:** set up buildx action for multi platform build ([a36e41c](https://github.com/mavinnarath/dmarcguard/commit/a36e41c02e6af54297275042e269c66b85545a78))
* **CI:** update dockerignore after main.go change ([1241b2f](https://github.com/mavinnarath/dmarcguard/commit/1241b2f22b8138348b7bf087ba00659e0b1f6fe8))
* **CI:** update goreleaser after moving FE to root ([357d37e](https://github.com/mavinnarath/dmarcguard/commit/357d37ed69d9cd7400c05c2f7ca2667072f4d46d))
* **CI:** update mcp registry version identifier ([a135890](https://github.com/mavinnarath/dmarcguard/commit/a135890747ef5fc07e43a7c9ed16e4dc21ac592b))
* **CI:** update the digest name for attestation ([eb692a8](https://github.com/mavinnarath/dmarcguard/commit/eb692a81fb08205990e639ab6c54c8998c705cd0))
* **CI:** update version of the binary ([0a8f023](https://github.com/mavinnarath/dmarcguard/commit/0a8f0230b30229349db270aa065e3332da63990a))
* **CI:** use go version file when setting up go ([40fbcb1](https://github.com/mavinnarath/dmarcguard/commit/40fbcb1dfbe962c7d48ef2c821ee32d997e7c78c))
* **CI:** use oxc the default vite minifier ([2cc92e1](https://github.com/mavinnarath/dmarcguard/commit/2cc92e1d85734bc1cc34b91b209eb66b13336b5d))
* **deps:** update module github.com/caarlos0/env/v11 to v11.4.0 ([#104](https://github.com/mavinnarath/dmarcguard/issues/104)) ([e14e6d2](https://github.com/mavinnarath/dmarcguard/commit/e14e6d2d7e8ecbfd8d7e5564c600b165b4135946))
* **deps:** update module github.com/caarlos0/env/v11 to v11.4.1 ([#155](https://github.com/mavinnarath/dmarcguard/issues/155)) ([31398d3](https://github.com/mavinnarath/dmarcguard/commit/31398d31413b2c204fb4fd0946bc3d087a490b77))
* **deps:** update module github.com/coreos/go-oidc/v3 to v3.17.0 ([#64](https://github.com/mavinnarath/dmarcguard/issues/64)) ([306583c](https://github.com/mavinnarath/dmarcguard/commit/306583cc37ba2c4fc7e7fffd542cdbab3edd119d))
* **deps:** update module github.com/goccy/go-json to v0.10.6 ([#119](https://github.com/mavinnarath/dmarcguard/issues/119)) ([7ad51d3](https://github.com/mavinnarath/dmarcguard/commit/7ad51d3a0b0395d99b542293ae5dd2a0b1e7ad32))
* **deps:** update module github.com/mattn/go-sqlite3 to v1.14.34 ([#85](https://github.com/mavinnarath/dmarcguard/issues/85)) ([5336d3a](https://github.com/mavinnarath/dmarcguard/commit/5336d3a64e647c32f46ddeb7d08c76fabd2a1200))
* **deps:** update module github.com/mattn/go-sqlite3 to v1.14.38 ([#129](https://github.com/mavinnarath/dmarcguard/issues/129)) ([40fb4d4](https://github.com/mavinnarath/dmarcguard/commit/40fb4d4a9f2048af86f3cf77be12df5a16cf134b))
* **deps:** update module github.com/modelcontextprotocol/go-sdk to v1 ([#49](https://github.com/mavinnarath/dmarcguard/issues/49)) ([58c0e79](https://github.com/mavinnarath/dmarcguard/commit/58c0e79699392fe6661a8e6cce3092c4dd0d598f))
* **deps:** update module github.com/modelcontextprotocol/go-sdk to v1.3.1 ([#102](https://github.com/mavinnarath/dmarcguard/issues/102)) ([68a80a4](https://github.com/mavinnarath/dmarcguard/commit/68a80a4ab077af0ce4f45046211aaa77288de42b))
* **deps:** update module github.com/modelcontextprotocol/go-sdk to v1.4.0 ([#107](https://github.com/mavinnarath/dmarcguard/issues/107)) ([39f1fcb](https://github.com/mavinnarath/dmarcguard/commit/39f1fcb833098df1e2b3ab9d89c47350475055e6))
* **deps:** update module github.com/modelcontextprotocol/go-sdk to v1.4.1 ([#127](https://github.com/mavinnarath/dmarcguard/issues/127)) ([ce63d91](https://github.com/mavinnarath/dmarcguard/commit/ce63d9146a8865e1f1bf5869b6502b6f62c30dc5))
* **deps:** update module github.com/modelcontextprotocol/go-sdk to v1.6.1 ([#151](https://github.com/mavinnarath/dmarcguard/issues/151)) ([eb1fb95](https://github.com/mavinnarath/dmarcguard/commit/eb1fb953b6e91199a7de4df959802a2dffdeb9ef))
* **deps:** update module github.com/urfave/cli/v3 to v3.6.2 ([#25](https://github.com/mavinnarath/dmarcguard/issues/25)) ([955e4e0](https://github.com/mavinnarath/dmarcguard/commit/955e4e04d4d1d40617721ac4ec4aa70eaabad4ca))
* **deps:** update module github.com/urfave/cli/v3 to v3.7.0 ([#110](https://github.com/mavinnarath/dmarcguard/issues/110)) ([8ce7090](https://github.com/mavinnarath/dmarcguard/commit/8ce7090ce717ce25b563d2532b6a1a4abe7555b0))
* **deps:** update module github.com/urfave/cli/v3 to v3.8.0 ([#135](https://github.com/mavinnarath/dmarcguard/issues/135)) ([dc06765](https://github.com/mavinnarath/dmarcguard/commit/dc06765f9d65c0dd67a2debcb12ed3499813ed05))
* **deps:** update module modernc.org/sqlite to v1.45.0 ([#27](https://github.com/mavinnarath/dmarcguard/issues/27)) ([2daa3b4](https://github.com/mavinnarath/dmarcguard/commit/2daa3b4177bd5298e0f04eea8405fede27446ac2))
* **deps:** update module modernc.org/sqlite to v1.46.1 ([#101](https://github.com/mavinnarath/dmarcguard/issues/101)) ([087c4e7](https://github.com/mavinnarath/dmarcguard/commit/087c4e79f1fe433f82e2245a654c4e09701b69de))
* **dev:** bring the frontend to the root and simplify docker ([edc64e7](https://github.com/mavinnarath/dmarcguard/commit/edc64e7417c910b7200bb1d727f0ba200c1a787d))
* **dev:** minify html with vite plugin ([10eb4f7](https://github.com/mavinnarath/dmarcguard/commit/10eb4f73ce936cc7def91d5aa633f2398b19fa33))
* **dev:** remove extra compose file ([eb71b09](https://github.com/mavinnarath/dmarcguard/commit/eb71b097005bb9d024454ee6d84c2ce5fbb59d7b))
* **dev:** remove user from compose ([e9fbf73](https://github.com/mavinnarath/dmarcguard/commit/e9fbf73b72a2a9958d62ed6f6ffea4bad2f2771f))
* do not overwrite release notes from goreleaser ([43bec10](https://github.com/mavinnarath/dmarcguard/commit/43bec1038b8a4ee46c6a898c89d918596bab0fdc))
* **docker:** create DB parent dirs ([e8d6497](https://github.com/mavinnarath/dmarcguard/commit/e8d6497227119e4e7e0d348f10386e4b657b630d)), closes [#138](https://github.com/mavinnarath/dmarcguard/issues/138)
* **docs:** add the missing png ([c9937ce](https://github.com/mavinnarath/dmarcguard/commit/c9937cea0649a48ed92c973f223a25f8ef112f0f))
* **docs:** clean up the providers ([6879ca7](https://github.com/mavinnarath/dmarcguard/commit/6879ca70d2a9e5d1adc7f7732d2a85869aecdd2e))
* **docs:** pin to full version for now ([2060e45](https://github.com/mavinnarath/dmarcguard/commit/2060e451a3b7322d933ad4b8f389f28474f85fb1))
* **docs:** reference dockerhub image ([b2d2b06](https://github.com/mavinnarath/dmarcguard/commit/b2d2b0627dbf423d760b5ee9598060334b13f290))
* **docs:** simplify README for first-time viewers ([#15](https://github.com/mavinnarath/dmarcguard/issues/15)) ([7341b7b](https://github.com/mavinnarath/dmarcguard/commit/7341b7bb022e5e96798e6d8d3523a377e282cf6f))
* **docs:** update imap-host env var ([#116](https://github.com/mavinnarath/dmarcguard/issues/116)) ([6d5aa4f](https://github.com/mavinnarath/dmarcguard/commit/6d5aa4f32a13956723138ed786f599ad81b229c8))
* **docs:** update quickstart command with volume ([617c258](https://github.com/mavinnarath/dmarcguard/commit/617c2584402cb309e1a652630f5f75de92df0b2e))
* **goreleaser:** take build arg for copying binary in dockerfile ([5fb9504](https://github.com/mavinnarath/dmarcguard/commit/5fb9504f1d7a946edf0c7c0a62eed13c1abbeb8d))
* make github star non-intrusive ([831047b](https://github.com/mavinnarath/dmarcguard/commit/831047b88394cd468ff57bc08c53907880e0feee))
* make linter happy ([900e314](https://github.com/mavinnarath/dmarcguard/commit/900e314e9c32909475db562c5b6d4b038496550e))
* make server context aware and do not fail UI on empty result ([588c466](https://github.com/mavinnarath/dmarcguard/commit/588c4660534d4111cf24738a952cbad56ebbf345))
* **mcp:** handle json error ([d17a04f](https://github.com/mavinnarath/dmarcguard/commit/d17a04f23994911118f30522ea3ca909fb203efd))
* move cli init to cmd/ and grab values using Destination syntax ([e04af1a](https://github.com/mavinnarath/dmarcguard/commit/e04af1aefd1c33c74780afd2b4e00805a951c1b0))
* move main.go to the root ([0dd5787](https://github.com/mavinnarath/dmarcguard/commit/0dd57878ec5f7d6707faca0189834a6d91c266e5))
* propagate errors with context ([85014c8](https://github.com/mavinnarath/dmarcguard/commit/85014c8aafaf03a6d6b512a7be7eaccab971a4b0))
* publish to grafana community dashboards instead ([86f40b0](https://github.com/mavinnarath/dmarcguard/commit/86f40b052607861de3d1a843f9e9c9e08ba57481))
* remove broken dns generator ([df39352](https://github.com/mavinnarath/dmarcguard/commit/df393527710b487bc0bdbe7d67d9a3f909623b92))
* stay compliant with brew core version print contraint ([35f8261](https://github.com/mavinnarath/dmarcguard/commit/35f826169b3864811cc7684e7c87190518c373a5))
* switch env and json config parsing order ([#83](https://github.com/mavinnarath/dmarcguard/issues/83)) ([12afcd2](https://github.com/mavinnarath/dmarcguard/commit/12afcd2e295c31b60a4696ba5c80edac1ae424e2)), closes [#84](https://github.com/mavinnarath/dmarcguard/issues/84)
* **UI:** handle no data in compliance score ([#90](https://github.com/mavinnarath/dmarcguard/issues/90)) ([eced435](https://github.com/mavinnarath/dmarcguard/commit/eced435ab7b08a73829d4b7b6e09ed31d324834b))
* update docker image reference to dockerhub ([6afcb3a](https://github.com/mavinnarath/dmarcguard/commit/6afcb3abe19beda674d19ab7911019c384ba54b1))
* update the UI on reports API parsing ([b85b59e](https://github.com/mavinnarath/dmarcguard/commit/b85b59ef577ffeb6b4dacd1188e6e55d549b1b5a))
* use app for static config ([3820862](https://github.com/mavinnarath/dmarcguard/commit/3820862f8fffe26fd3dad7c004d1c0b04fc8be9e))
* use PEEK when mark-seen is set to false ([#125](https://github.com/mavinnarath/dmarcguard/issues/125)) ([e54e269](https://github.com/mavinnarath/dmarcguard/commit/e54e26900faed10f916afed47d23b3a2a1f65467))
* use png for favicon ([4704ad7](https://github.com/mavinnarath/dmarcguard/commit/4704ad7c23fbd31913adf677e50f001393a1adda))


### Miscellaneous Chores

* prepare next release 1.4.3 ([141e2ed](https://github.com/mavinnarath/dmarcguard/commit/141e2ed8c97a34e3d24d359645c0aa67237a47eb))
